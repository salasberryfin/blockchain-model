...
--
-- Host: localhost    Database: blockchain_db
-- ------------------------------------------------------
...
CREATE TABLE `blockchain` (
  ...
  `previous_block_hash` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `transaction_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `transaction_id` (`transaction_id`),
  CONSTRAINT `blockchain_ibfk_1` FOREIGN KEY (`transaction_id`) REFERENCES `transactions` (`id`)
...
-- Dump completed on 2019-12-04 17:44:35
